...
use crate::{
  entity::{
    Action, AiType, AnimTick, Damage, DirIntent, Entity, EntityManager, Facing, Health, HitBoxRad,
    LastShotAt, Layer, Npc, Position, Projectile, RenderSize, Rotation, Speed, TextureType,
  },
